...
0f493fed5cc9: constructor() : 擬似メンバの値設定、変更履歴テーブルの準備
...
"SpreadDb"はGoogle Spread上のシートを記憶領域とし、参照・更新・削除およびテーブル構造情報取得を実現するライブラリ。
...
エラーコードについては「[エラーの種類](#60cbb24d684c)」参照

## <a name="a9f01a749b53">内部関数 - 非command系</a>

### <a name="0f493fed5cc9">constructor() : 擬似メンバの値設定、変更履歴テーブルの準備</a>
