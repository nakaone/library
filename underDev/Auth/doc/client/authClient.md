...
| 項目名 | データ型 | 要否/既定値 | 説明 |
| :-- | :-- | :-- | :-- |
| cf | <a href="../index.<a href="../index.md#md">md</a>#authClientConfig">authClientConfig</a> | 必須 | authClient設定情報 |
| idb | Object | 必須 | IndexedDBと同期、authClient内で共有 |
| crypto | <a href="../cryptoClient.<a href="../index.md#md">md</a>">cryptoClient</a> | 必須 | 暗号化・署名検証 |
...
| データ型 | 説明 |
| :-- | :-- |
| <a href="../index.<a href="../index.md#md">md</a>#authResponse">authResponse</a> \| Error | 処理結果 |
...
| データ型 | 説明 |
| :-- | :-- |
| <a href="../authClient.<a href="../index.md#md">md</a>">authClient</a> \| Error |  |
