...
| cols | <a href="../ColumnDef.<a href="../index.md#md">md</a>">ColumnDef</a>[] | 必須 | 項目定義（順序を考慮するため配列） |
| header | string[] | 必須 | 項目名の一覧(引数不可、自動生成) |
| map | Object.<string, <a href="../ColumnDef.<a href="../index.md#md">md</a>">ColumnDef</a>> | 必須 | 項目名をキーとする項目定義集(引数不可、自動生成) |
...
| データ型 | 説明 |
| :-- | :-- |
| <a href="../TableDef.<a href="../index.md#md">md</a>">TableDef</a> \| Error |  |
