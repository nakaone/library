...
<p class="source">source: lib/createSpec.1_0_0.mjs line.35</p>JavaScriptソース(JSDoc)からMarkdown仕様書を作成

## <a href="#createSpec_top"><span id="createSpec_func">🧱 createSpec メソッド・内部関数一覧</span></a>

| No | 名前 | 概要 |
| --: | :-- | :-- |
| 1 | <a href="#createSpec-DocletColRow_top">DocletColRow</a> | データ項目一覧作成用追加情報 |
| 2 | <a href="#createSpec-DocletColDef_top">DocletColDef</a> | Doclet.properties/params/returnsの要素(メンバ)定義情報 |
| 3 | <a href="#createSpec-Doclet_top">Doclet</a> | `jsdoc -X`で配列で返されるオブジェクト |
| 4 | <a href="#createSpec-decision logic of docletType_top">decision logic of docletType</a> | docletTypeの判定ロジック |
| 5 | <a href="#createSpec-"longname" naming rules_top">"longname" naming rules</a> | docletType毎のlongname命名規則 |
| 6 | <a href="#createSpec-DocletEx_top">DocletEx</a> | jsdocから出力されるDocletに情報を付加したもの |
| 7 | <a href="#createSpec-DocletTreeFile_top">DocletTreeFile</a> | 個別入力ファイル情報 |
| 8 | <a href="#createSpec-DocletTreeSource_top">DocletTreeSource</a> | 統合版入力ファイル(JSソース)情報 |
| 9 | <a href="#createSpec-DocletTreeSymbol_top">DocletTreeSymbol</a> | クラス・グローバル関数名・データ型定義名から参照先URLへの変換情報 |
| 10 | <a href="#createSpec-DocletTreeOpt_top">DocletTreeOpt</a> | オプション設定値 |
| 11 | <a href="#createSpec-listSource_top">listSource</a> | 事前準備、対象ファイルリスト作成 |
...
<p class="source">source: lib/createSpec.1_0_0.mjs line.102</p>データ項目一覧作成用追加情報
...
<p class="source">source: lib/createSpec.1_0_0.mjs line.111</p>Doclet.properties/params/returnsの要素(メンバ)定義情報
...
<p class="source">source: lib/createSpec.1_0_0.mjs line.133</p>`jsdoc -X`で配列で返されるオブジェクト
...
## <span id="createSpec-decision logic of docletType_top">🧩 decision logic of docletType</span>

docletTypeの判定ロジック

### <a href="#createSpec-decision logic of docletType_top"><span id="createSpec-decision logic of docletType_desc">🧾 decision logic of docletType 概説</span></a>
...
## <span id="createSpec-"longname" naming rules_top">🧩 "longname" naming rules</span>

docletType毎のlongname命名規則

### <a href="#createSpec-"longname" naming rules_top"><span id="createSpec-"longname" naming rules_desc">🧾 "longname" naming rules 概説</span></a>
...
<p class="source">source: lib/createSpec.1_0_0.mjs line.675</p>個別入力ファイル情報
...
<p class="source">source: lib/createSpec.1_0_0.mjs line.685</p>統合版入力ファイル(JSソース)情報
...
<p class="source">source: lib/createSpec.1_0_0.mjs line.702</p>クラス・グローバル関数名・データ型定義名から参照先URLへの変換情報
...
<p class="source">source: lib/createSpec.1_0_0.mjs line.710</p>オプション設定値
