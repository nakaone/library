...
| 10 | <a href="#createSpec-DocletTreeFolder_top">DocletTreeFolder</a> | パス毎の所属Doclet管理(フォルダ管理) |
...
| properties | <a href="../index.<a href="../index.md#md">md</a>#DocletColDef">DocletColDef</a>[] | 任意 | メンバ一覧 |
| params | <a href="../index.<a href="../index.md#md">md</a>#DocletColDef">DocletColDef</a>[] | 任意 | 引数。クラスの場合はconstructorの引数(※同上) |
| returns | <a href="../index.<a href="../index.md#md">md</a>#DocletColDef">DocletColDef</a>[] | [] | 戻り値(※同上) |
...
| 項目名 | データ型 | 要否/既定値 | 説明 |
| :-- | :-- | :-- | :-- |
| doclet | <a href="../index.<a href="../index.md#md">md</a>#Doclet">Doclet</a> | 必須 |  |
| opt | Object | {} | オプション設定値 |
...
| 項目名 | データ型 | 要否/既定値 | 説明 |
| :-- | :-- | :-- | :-- |
| prop | <a href="../index.<a href="../index.md#md">md</a>#DocletColDef">DocletColDef</a> | 必須 | データ項目情報 |
...
| データ型 | 説明 |
| :-- | :-- |
| <a href="../index.<a href="../index.md#md">md</a>#DocletColRow">DocletColRow</a> \| Error |  |
...
| データ型 | 説明 |
| :-- | :-- |
| <a href="../index.<a href="../index.md#md">md</a>#DocletTreeSource">DocletTreeSource</a> \| string \| Error | 入力0件なら文字列"No input file" |