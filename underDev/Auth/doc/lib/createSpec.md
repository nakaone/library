...
<p class="source">source: lib/createSpec.1_0_0.mjs line.717</p>個別入力ファイル情報
...
<p class="source">source: lib/createSpec.1_0_0.mjs line.727</p>統合版入力ファイル(JSソース)情報
...
<p class="source">source: lib/createSpec.1_0_0.mjs line.744</p>クラス・グローバル関数名・データ型定義名から参照先URLへの変換情報
...
<p class="source">source: lib/createSpec.1_0_0.mjs line.752</p>オプション設定値
