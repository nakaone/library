...
| types | Object.<string, <a href="../TableDef.<a href="../index.md#md">md</a>">TableDef</a>> | 必須 | 論理テーブル名をキーとするテーブル定義 |
...
| 項目名 | データ型 | 要否/既定値 | 説明 |
| :-- | :-- | :-- | :-- |
| arg | <a href="../Schema.<a href="../index.md#md">md</a>">Schema</a>[] | [{} | 設定情報集。後順位優先。共通設定を先頭に特有設定の追加を想定 |

### <a href="#Schema-constructor_top"><span id="Schema-constructor_return">◀️ constructor 戻り値</span></a>

| データ型 | 説明 |
| :-- | :-- |
| <a href="../Schema.<a href="../index.md#md">md</a>">Schema</a> \| Error |  |