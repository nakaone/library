...
| No | 名前 | 概要 |
| --: | :-- | :-- |
| 1 | <a href="#/client/authClient.mjs::authClient_top">authClient</a> | authClient: クライアント側中核クラス |
| 2 | <a href="#/server/authServer.mjs::authServer.initialize_top">initialize</a> | initialize: authServerインスタンス作成 |
| 3 | <a href="#/server/authServer.mjs::authServer#exec_top">exec</a> | exec: 処理要求に対するサーバ側中核処理 |
| 4 | <a href="#/server/authServer.mjs::authServer.resetSPkey_top">resetSPkey</a> | resetSPkey: 緊急時、サーバ側鍵ペアを更新 |
| 5 | <a href="#/server/authServer.mjs::authServer.setupEnvironment_top">setupEnvironment</a> | setupEnvironment: 初回実行時に必要なOAuth権限を一括取得 |
