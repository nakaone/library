...
| 7 | <a href="#Member-MemberDevice_top">MemberDevice</a> | MemberDevice: デバイス情報の初期オブジェクト生成 |
| 8 | <a href="#Member-MemberLog_top">MemberLog</a> | MemberLog: メンバ履歴情報初期化 |
| 9 | <a href="#Member-MemberProfile_top">MemberProfile</a> | MemberProfile: メンバ属性情報初期化 |
