...
| func | <a href="../server/index.md#authServerFuncDef">authServerFuncDef</a> | {} | サーバ側関数設定 | ログイン試行関係の設定値 |
...
| log | <a href="../server/index.md#MemberTrialLog">MemberTrialLog</a>[] | [ | 試行履歴常に最新が先頭(unshift()使用) | 保持上限はauthServerConfig.trial.generationMaxに従い、上限超過時は末尾から削除する。 |
