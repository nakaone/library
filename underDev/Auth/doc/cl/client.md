...
| 4.00 | [authResponse](authResponse.md#authresponse_members) | クライアント側で復号されたサーバからの処理結果 |
| 4.01 | <span style="padding-left:2rem">[constructor](authResponse.md#authresponse_constructor)</span> | コンストラクタ |
| 5.00 | [encryptedRequest](encryptedRequest.md#encryptedrequest_members) |  |
| 5.01 | <span style="padding-left:2rem">[constructor](encryptedRequest.md#encryptedrequest_constructor)</span> | コンストラクタ |
| 6.00 | [LocalRequest](LocalRequest.md#localrequest_members) | ローカル関数からの処理要求 |
| 6.01 | <span style="padding-left:2rem">[constructor](LocalRequest.md#localrequest_constructor)</span> | コンストラクタ |
