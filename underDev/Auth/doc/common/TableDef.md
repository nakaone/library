...
| :-- | :-- | :-- | :-- | :-- |
| name | string | 必須 | 論理的な識別名（TableDef のキー） | - クラス・API・ログで使用。例: 'Member', 'AuthAuditLog'
...
| No | 名前 | 概要 |
| --: | :-- | :-- |
| 1 | <a href="#TableDef-constructor_top">constructor</a> |  |
| 2 | <a href="#TableDef-factory_top">factory</a> | factory: 論理テーブル構造定義を基に実オブジェクトを生成 |

## <a href="#TableDef_top"><span id="TableDef_desc">🧾 TableDef 概説</span></a>

TableDef: 論理テーブル構造定義
- name~colsはインスタンス生成時に指定、header以下は自動生成<br>
## <span id="TableDef-constructor_top">🧩 constructor()</span>

### <a href="#TableDef-constructor_top"><span id="TableDef-constructor_desc">🧾 constructor 概説</span></a>
...
### <a href="#TableDef-factory_top"><span id="TableDef-factory_desc">🧾 factory 概説</span></a>

factory: 論理テーブル構造定義を基に実オブジェクトを生成<br>
