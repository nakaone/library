...
| No | 受信データ | mId | dId | CPkey | メンバ | デバイス | func | 処理内容 | 戻り値 |
| --: | :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- |
| 1 | 平文 | — | — | — | — | — | — | 仮登録処理 | ⭕SPkey配布 |
| 2 |  |  |  |  |  |  |  |  | ❌CPkey重複 |
| 3 | 暗号文 | 不在 | — | — | — | — | — | — | ❌メンバ未登録 |
| 4 |  | 存在 | 不在 | — | — | — | — | — | ❌デバイス未登録 |
| 5 |  |  | 存在 | 不在 | — | — | — | — | ❌CPkey未登録 |
| 6 |  |  |  | 旧版 | — | — | ::updateCPkey:: | CPkey更新 | ⭕CPkey更新 |
| 7 |  |  |  |  |  |  | 上記以外 |  | 🔺要CPkey更新 |
| 8 |  |  |  | 存在 | 加入禁止 | — |  | 限定処理 | ⭕処理結果 |
| 9 |  |  |  |  |  |  |  |  | ❌加入禁止 |
| 10 |  |  |  |  | 仮登録 | — |  | 限定処理 | ⭕処理結果 |
...
| 12 |  |  |  |  | 未審査 | — |  | 限定処理 | ⭕処理結果 |
| 13 |  |  |  |  |  |  |  |  | ❌未審査 |
| 14 |  |  |  |  | 加入中 | 凍結中 |  | 限定処理 | ⭕処理結果 |
| 15 |  |  |  |  |  |  |  |  | ❌凍結中 |
| 16 |  |  |  |  |  | 試行中 | ::passcode:: | パスコード検証 | ⭕一致 |
| 17 |  |  |  |  |  |  |  |  | 🔺要再試行 |
| 18 |  |  |  |  |  |  |  |  | ❌凍結中 |
| 19 |  |  |  |  |  |  | ::reissue:: | パスコード再発行 | ⭕再発行 |
| 20 |  |  |  |  |  |  | 上記以外 | 限定処理 | ⭕処理結果 |
| 21 |  |  |  |  |  |  |  |  | ❌凍結中 |
| 22 |  |  |  |  |  | 未認証 |  | 試行開始処理 | ⭕通知メール送信 |
| 23 |  |  |  |  |  | 認証中 |  | 通常処理 | ⭕処理結果 |
